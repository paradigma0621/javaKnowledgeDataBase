...
* ParameterizedTest com ValueSource
    @ParameterizedTest
    @ValueSource(strings = {"SYSTEM", "USER", "ADMINISTRATOR"})
    void shouldAllowWhenProfileDoesNotExistInRBAC(String profile) {
        configuration.setRbac(Collections.emptyMap());
        assertThatCode(() -> runFilter("/users/1", HttpMethod.GET, profile, true))
